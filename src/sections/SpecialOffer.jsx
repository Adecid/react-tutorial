  ...
  return (
    <section className="flex justify-center items-center max-xl:flex-col-reverse gap-10 max-container">
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-6 lg:max-w-lg info-text">Navigate a realm of posibilitites designed to fufill your uique desires, surpassing the loftiest expectations. Your jouney with us is nothing short of exceptional.</p>
